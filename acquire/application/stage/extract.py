...
# Version    : 0.2.0                                                                               #
# Python     : 3.10.14                                                                             #
# Filename   : /acquire/application/stage/extract.py                                               #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
from acquire.application.stage.base import Stage
from acquire.core.enum import StageType
from acquire.domain.artifact.request.base import AsyncRequest
from acquire.domain.artifact.response.response import AsyncResponse
